...
try:
    ...
    from omar.query.query_models.default.services.rag_store import store as rag_store
except Exception:
    from ..services.loinc_index import LoincIndex
    from ..query.query_models.default.services.rag_store import store as rag_store
try:
    # Prefer absolute-style import first to satisfy some analyzers
    from omar.services.document_search_service import get_or_build_index_for_dfn  # type: ignore
except Exception:
