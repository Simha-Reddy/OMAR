...
This `app/` package contains the Flask application code for OMAR_refactor. It is organized into layered concerns: request routing (blueprints), external system gateways, RAG / query models, scribe (audio + note drafting), AI tooling utilities, and domain services.
